    ...
    if (multipleFilters.brand.includes(true)) {
      if (multipleFilters.brand[0]) {
        tempProducts.forEach((product) => {
          if (product.productName === "Intelligent Granite Car")
            filteredData.push(product);
        });
      }
      if (multipleFilters.brand[1]) {
        tempProducts.forEach((product) => {
          if (product.productName === "Incredible Soft Tuna")
            filteredData.push(product);
        });
      }
      filter1Applied = true;
            ...
            {showBrandFilter && (
              <div>
                <div className="input_label_container">
                  ...
                  />
                  <label>Intelligent Granite Car</label>
                </div>
                <div className="input_label_container">
                  <input
                    type="checkbox"
                  ...
                  />
                  <label>Incredible Soft Tuna</label>
                </div>
              </div>
            )}
          </div>
